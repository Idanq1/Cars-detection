...
# Create train data:
python generate_tfrecord.py --csv_input=Dataset\train.csv --output_path=Dataset\train.record --img_path=Dataset\Train --label_map label_map.pbtxt

# Create test data:
python generate_tfrecord.py --csv_input=Dataset\test.csv --output_path=Dataset\test.record --img_path=Dataset\Test --label_map label_map.pbtxt
"""
